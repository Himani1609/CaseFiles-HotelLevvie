// const chapter2Content = document.getElementById("chapter-2-content");
const chapter2Solve = document.getElementById("chapter-2-solve");
const full_chapter = document.getElementById("Chapter-2-solve");
...
//   chapter2Content.classList.add("center-card");;
//   chapter2Solve.style.display = "none";
// }

// function displaychapter2Solve() {
...
// const correct_chapter_2 = JSON.parse(localStorage.getItem('Chapter-1'));
...
check.onclick = function() {
  ...
  console.log("Correct Chapter 2:", correct_chapter_2);
  console.log("Current List:", submitted_ids);

  let isCorrect = [true, true, true];
  let flag = true;

  if (submitted_ids.length !== correct_chapter_2.length) {
    isCorrect = [false, false, false];
   error.innerHTML = "You need to select 3 fragment pieces";
  } else {
    error.innerHTML = "";
    for (let i = 0; i < correct_chapter_2.length; i++) {
      if (submitted_ids[i] === correct_chapter_2[i]) {
        isCorrect[i] = true;
      } else if (correct_chapter_2.includes(submitted_ids[i])) {
...
if(correct2){
  chapter2Solve.style.display = "none";
  full_chapter.innerHTML = "<h1 class='text-center text-white'>You have Solved The Chapter - 2</h1>";
